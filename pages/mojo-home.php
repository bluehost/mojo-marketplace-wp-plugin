						...
						<div>
							...
							<div class="col-xs-12 col-sm-12 text-right">
								<a
									...
									href="<?php echo esc_url( add_query_arg( array( 'taxonomy' => 'category' ), admin_url( 'edit-tags.php' ) ) ); ?>"
								>
									<small><?php esc_html_e( 'Manage Categories', 'mojo-marketplace-wp-plugin' ); ?></small>
								</a>
								<a
									class="btn btn-primary btn-md"
									href="<?php echo esc_url( admin_url( 'post-new.php' ) ); ?>"
								>
									<?php esc_html_e( 'Add New Post', 'mojo-marketplace-wp-plugin' ); ?>
								</a>
							</div>
						</div>
					</div>
					...
					<div class="panel panel-default panel-body">
						<div>
							...
							<div class="col-xs-12 col-sm-8 col-sm-offset-4 text-right">
								<a
									class="btn btn-primary btn-md"
									href="<?php echo esc_url( add_query_arg( array( 'post_type' => 'page' ), admin_url( 'post-new.php' ) ) ); ?>"
								>
									<?php esc_html_e( 'Add New Page', 'mojo-marketplace-wp-plugin' ); ?>
								</a>
							</div>
						</div>
					</div>
					...
					<div class="panel panel-default panel-body">
						<div>
							...
							<div class="col-xs-12 col-sm-8 col-sm-offset-4 text-right">
								...
								>
									<?php esc_html_e( 'Manage', 'mojo-marketplace-wp-plugin' ); ?>
								</a>
							</div>
						</div>
					</div>
					...
					<div class="panel panel-default panel-body">
						<div>
							<div class="col-xs-12 clearfix">
								...
								<img
									class="pull-right"
									src="<?php echo esc_url( plugins_url( '../images/woocommerce.png', __FILE__ ) ); ?>"
									width="150"
								/>
							</div>
							...
							<div class="col-xs-12 col-sm-8 col-sm-offset-4 text-right">
								...
								if ( is_plugin_active( 'woocommerce/woocommerce.php' ) ) {
									echo '<a class="btn btn-primary btn-md" href="' . esc_url( add_query_arg( array( 'post_type' => 'product' ), admin_url( 'edit.php' ) ) ) . '">' . esc_html__( 'Manage Products', 'mojo-marketplace-wp-plugin' ) . '</a>';
								} elseif ( file_exists( WP_CONTENT_DIR . '/plugins/woocommerce/woocommerce.php' ) ) {
									echo '<a class="btn btn-primary btn-md" href="' . esc_url( wp_nonce_url( 'plugins.php?action=activate&plugin=' . rawurlencode( 'woocommerce/woocommerce.php' ), 'activate-plugin_woocommerce/woocommerce.php' ) ) . '">' . esc_html__( 'Activate WooCommerce', 'mojo-marketplace-wp-plugin' ) . '</a>';
								} else {
									echo '<a class="btn btn-primary btn-md" href="' . esc_url( wp_nonce_url( admin_url( 'update.php?action=install-plugin&plugin=woocommerce' ), 'install-plugin_woocommerce' ) ) . '">' . esc_html__( 'Install WooCommerce', 'mojo-marketplace-wp-plugin' ) . '</a>';
								}
								?>
							</div>
						</div>
			...
			<div class="row">
					...
					<div class="panel panel-default panel-body">
						<div class="clearfix">
							...
							<div class="btn-group home-btn-group clearfix panel-body col-sm-12">
								<a href="<?php echo esc_url( admin_url( '/themes.php' ) ); ?>" class="btn btn-primary btn-md">
									<?php esc_html_e( 'Free Themes', 'mojo-marketplace-wp-plugin' ); ?>
								</a>
							</div>
						</div>
					</div>
								...
								<div>
									...
									<div class="col-xs-12 col-sm-8 col-sm-offset-4 text-right">
										<a
											...
											href="<?php echo esc_url( add_query_arg( array( 'page' => 'mojo-staging' ), admin_url( 'admin.php' ) ) ); ?>"
										>
											<?php esc_html_e( 'Get Started', 'mojo-marketplace-wp-plugin' ); ?>
										</a>
									</div>
								</div>
							</div>
				...
				<?php if ( is_plugin_active( 'jetpack/jetpack.php' ) ) { ?>
					<div class="row">
						...
						<div class="col-xs-12 col-sm-<?php echo esc_attr( $te_size ); ?>">
							<div class="panel panel-default panel-body">
								<div>
									...
									<div class="col-xs-12 col-sm-8 col-sm-offset-4 text-right">
										<a
											class="btn btn-primary btn-md"
											href="<?php echo esc_url( add_query_arg( array( 'page' => 'jetpack#/sharing' ), admin_url( 'admin.php' ) ) ); ?>"
										>
											<?php esc_html_e( 'Manage', 'mojo-marketplace-wp-plugin' ); ?>
										</a>
									</div>
							...
							<div>
								...
								<div class="col-xs-12 col-sm-8 col-sm-offset-4 text-right">
									<a
										...
										href="<?php echo esc_url( add_query_arg( array( 'page' => 'jetpack#/sharing' ), admin_url( 'admin.php' ) ) ); ?>"
									>
										<?php esc_html_e( 'Configure', 'mojo-marketplace-wp-plugin' ); ?>
									</a>
								</div>
							</div>
						</div>
							...
							<div class="panel panel-default panel-body">
								<div>
									...
									<div class="col-xs-12 col-sm-8 col-sm-offset-4 text-right">
										<a
											class="btn btn-default btn-md"
											href="<?php echo esc_url( add_query_arg( array( 'page' => 'stats' ), admin_url( 'admin.php' ) ) ); ?>"
										>
											<?php esc_html_e( 'View Stats', 'mojo-marketplace-wp-plugin' ); ?>
										</a>
									</div>
								</div>
							</div>
							...
							<div class="panel panel-default panel-body text-center performance-card">
								<div>
									...
									<div class="col-xs-12 col-sm-12">
										<a
											class="btn btn-primary btn-md"
											href="<?php echo esc_url( add_query_arg( array( 'page' => 'mojo-performance' ), admin_url( 'admin.php' ) ) ); ?>"
										>
											<?php esc_html_e( 'Configure', 'mojo-marketplace-wp-plugin' ); ?>
										</a>
									</div>
								...
								<div>
									...
									<div class="col-xs-12 col-sm-12">
										...
										if ( is_plugin_active( 'jetpack/jetpack.php' ) ) {
											echo '<a class="btn btn-primary btn-md" href="' . esc_url( add_query_arg( array( 'page' => 'jetpack#/dashboard' ), esc_url( admin_url( 'admin.php' ) ) ) ) . '">' . esc_html__( 'Learn More', 'mojo-marketplace-wp-plugin' ) . '</a>';
										} elseif ( file_exists( WP_CONTENT_DIR . '/plugins/jetpack/jetpack.php' ) ) {
											echo '<a class="btn btn-primary btn-md" href="' . esc_url( wp_nonce_url( 'plugins.php?action=activate&plugin=' . rawurlencode( 'jetpack/jetpack.php' ), 'activate-plugin_jetpack/jetpack.php' ) ) . '">' . esc_html__( 'Activate Jetpack', 'mojo-marketplace-wp-plugin' ) . '</a>';
										} else {
											echo '<a class="btn btn-primary btn-md" href="' . esc_url( wp_nonce_url( admin_url( 'update.php?action=install-plugin&plugin=jetpack' ), 'install-plugin_jetpack' ) ) . '">' . esc_html__( 'Install Jetpack', 'mojo-marketplace-wp-plugin' ) . '</a>';
										}
										?>
									</div>
								</div>
								...
								<div>
									...
									<div class="col-xs-12 col-sm-8 col-sm-offset-4 text-right">
										<a
											...
											target="_blank"
										>
											<?php esc_html_e( 'Find a Domain', 'mojo-marketplace-wp-plugin' ); ?>
										</a>
									</div>
								</div>
							</div>
								...
								<div>
									...
									<div class="col-xs-12 col-sm-8 col-sm-offset-4 text-right">
										<a
											...
											target="_blank"
										>
											<?php esc_html_e( 'Help Me', 'mojo-marketplace-wp-plugin' ); ?>
										</a>
									</div>
								</div>
							</div>
